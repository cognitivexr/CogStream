...
func main() {
	...
	videoSrc := flag.String("video-src", "uridecodebin uri=file:///home/silvio/videos/sample/1920x1080.mp4 ! videoscale ! video/x-raw, width=1920, height=1080 ! queue", "GStreamer video src")
